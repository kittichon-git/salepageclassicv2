    ...
    <Section id="mechanism" tab="S3 · MECHANISM" tone="paper">
      <div className="space-y-8">
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-x-2 gap-y-1">
                    <span className="font-[family-name:var(--font-bai-jamjuree)] text-sm text-[var(--color-text-muted)] [overflow-wrap:break-word]">
                      ❌ &ldquo;{step.example.before}&rdquo;
                    </span>
                    <span className="font-[family-name:var(--font-jetbrains-mono)] text-xs text-[var(--color-text-muted)]">
                      →
                    </span>
                    <span className="font-[family-name:var(--font-bai-jamjuree)] text-sm text-[var(--color-navy-500)] [overflow-wrap:break-word]">
        ...
        <ScrollReveal delay={0.35}>
          <p className="font-[family-name:var(--font-bai-jamjuree)] text-base text-[var(--color-navy-500)] [overflow-wrap:break-word]">
            {mechanism.closing}
          </p>
        </ScrollReveal>
