...
export const hero = {
  ...
  headline: "เขียน 1 ประโยค\nขายของได้มากกว่าเขียน 100 ประโยค",
  body: "สูตรเปลี่ยน \u201cคำ\u201d 7 ภาค 24 บท ที่คนไทย 1,200+ คนใช้แล้วยอดขายขึ้น — ไม่ต้องเป็นนักเขียน แค่กรอกคำตามสูตร",
  vsl: {
    label: "VSL 60 วินาที",
    script:
...
export const finalCta = {
  heading: "เขียน 1 ประโยค ขายได้มากกว่าเขียน 100 ประโยค",
